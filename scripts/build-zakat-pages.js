...
function estimator(page) {
  ...
  return `        <form class="surface estimator" data-estimator>
          ...
          <p class="est-sub">A flat 2.5% of the already-calculated zakatable wealth you enter. The full app separately handles cash, metals, investments, pensions, business assets, receivables, digital assets and eligible debts.</p>
        ...
        <div class="container">
          <div class="spotlight surface">
            <div class="spotlight-copy reveal">
              ...
              <p>BarakahFlow applies your school, policy choices, region, currency and Hawl; itemizes cash, metals, shares, pensions, business inventory, receivables, property income, coins, stablecoins, tokens and NFTs; separates short- and long-term debts; and shows an auditable calculation record.</p>
